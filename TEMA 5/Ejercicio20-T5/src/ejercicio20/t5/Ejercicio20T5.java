...
// Llamamos al método ingresar del objeto miCuenta
                ...
                System.out.println("Se han ingresado " + cantidad + " Saldo actual: " + miCuenta.getSaldo());
            } else {
// Si no hay cuenta, mostramos un mensaje de error
            ...
            break;
        case 4:
// Opción 4: Sacar dinero.
// Primero verificamos si ya se ha creado una cuenta
            if (miCuenta != null) {
                System.out.print("Introduzca la cantidad a sacar: ");
                float cantidad = entrada.nextFloat();
// Llamamos al método extraer del objeto miCuenta
                miCuenta.extraer(cantidad);
                System.out.println("Se han sacado " + cantidad + " Saldo actual: " + miCuenta.getSaldo());
            } else {
// Si no hay cuenta, mostramos un mensaje de error
                System.out.println("Primero debe crear una cuenta");
}
...
// Primero verificamos si ya se ha creado una cuenta
            if (miCuenta != null) {
// Llamamos al método getSaldo del objeto miCuenta y mostramos el resultado
